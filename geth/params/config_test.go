...
var loadConfigTestCases = []struct {
	...
	},
	{
		...
		func(t *testing.T, dataDir string, nodeConfig *params.NodeConfig, err error) {
			...
			if nodeConfig.BootClusterConfig.RootHash != "baedfea6f6f4ddb47b9958ee33843b9f15a1a32ec00542a76b4988a0185f3540" {
				t.Fatal("invalid CHT hash")
			}

			if nodeConfig.BootClusterConfig.RootNumber < 245 {
	...
	},
	{
		...
		func(t *testing.T, dataDir string, nodeConfig *params.NodeConfig, err error) {
			...
			if nodeConfig.BootClusterConfig.RootHash != "d83aff2e2ba6a92a406865e6a0416f2476f2d2bb986fac166649569dfb0eb729" {
				t.Fatal("invalid CHT hash")
			}

			if nodeConfig.BootClusterConfig.RootNumber < 244 {
				t.Fatal("empty CHT number")
			}
